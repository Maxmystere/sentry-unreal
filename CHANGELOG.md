...
- Bump Java SDK (Android) from v8.16.0 to v8.24.0 ([#42](https://github.com/Maxmystere/sentry-unreal/pull/42))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.24.0)
