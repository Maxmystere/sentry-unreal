...
- Bump Java SDK (Android) from v8.16.0 to v8.52.0 ([#189](https://github.com/Maxmystere/sentry-unreal/pull/189))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.52.0)
