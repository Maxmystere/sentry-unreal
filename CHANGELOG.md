...
- Bump Java SDK (Android) from v8.16.0 to v8.26.0 ([#53](https://github.com/Maxmystere/sentry-unreal/pull/53))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.26.0)
