...
- Bump Java SDK (Android) from v8.16.0 to v8.40.0 ([#122](https://github.com/Maxmystere/sentry-unreal/pull/122))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.40.0)
