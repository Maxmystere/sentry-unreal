...
- Bump Java SDK (Android) from v8.16.0 to v8.19.0 ([#12](https://github.com/Maxmystere/sentry-unreal/pull/12))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.19.0)
