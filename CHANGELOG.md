...
- Bump Java SDK (Android) from v8.16.0 to v8.47.0 ([#168](https://github.com/Maxmystere/sentry-unreal/pull/168))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.47.0)
