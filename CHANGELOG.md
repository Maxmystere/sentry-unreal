...
- Bump Cocoa SDK (iOS and Mac) from v8.53.1 to v9.0.0 ([#57](https://github.com/Maxmystere/sentry-unreal/pull/57))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#900)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.53.1...9.0.0)
