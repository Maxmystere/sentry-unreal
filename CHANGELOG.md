...
- Bump Java SDK (Android) from v8.16.0 to v8.55.0 ([#202](https://github.com/Maxmystere/sentry-unreal/pull/202))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8550)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.55.0)
