...
- Bump Java SDK (Android) from v8.16.0 to v8.42.0 ([#138](https://github.com/Maxmystere/sentry-unreal/pull/138))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.42.0)
