...
- Bump Java SDK (Android) from v8.16.0 to v8.20.0 ([#18](https://github.com/Maxmystere/sentry-unreal/pull/18))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8200)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.20.0)
