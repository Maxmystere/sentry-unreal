...
- Bump Java SDK (Android) from v8.16.0 to v8.36.0 ([#102](https://github.com/Maxmystere/sentry-unreal/pull/102))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.36.0)
