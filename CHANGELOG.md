...
- Bump Java SDK (Android) from v8.16.0 to v8.45.0 ([#162](https://github.com/Maxmystere/sentry-unreal/pull/162))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.45.0)
