...
- Bump Java SDK (Android) from v8.16.0 to v8.56.0 ([#207](https://github.com/Maxmystere/sentry-unreal/pull/207))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8560)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.56.0)
