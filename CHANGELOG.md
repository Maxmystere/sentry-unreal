...
- Bump Cocoa SDK (iOS and Mac) from v8.53.1 to v8.54.0 ([#8](https://github.com/Maxmystere/sentry-unreal/pull/8))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.53.1...8.54.0)
