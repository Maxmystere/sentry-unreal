...
- Bump Java SDK (Android) from v8.16.0 to v8.46.0 ([#163](https://github.com/Maxmystere/sentry-unreal/pull/163))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.46.0)
