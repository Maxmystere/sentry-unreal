...
- Bump Java SDK (Android) from v8.16.0 to v8.34.0 ([#95](https://github.com/Maxmystere/sentry-unreal/pull/95))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.34.0)
