...
- Bump Java SDK (Android) from v8.16.0 to v8.37.0 ([#107](https://github.com/Maxmystere/sentry-unreal/pull/107))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.37.0)
