...
- Bump Java SDK (Android) from v8.16.0 to v8.23.0 ([#36](https://github.com/Maxmystere/sentry-unreal/pull/36))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.23.0)
