...
- Bump Java SDK (Android) from v8.16.0 to v8.54.0 ([#199](https://github.com/Maxmystere/sentry-unreal/pull/199))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.54.0)
