...
- Bump Java SDK (Android) from v8.16.0 to v8.51.0 ([#184](https://github.com/Maxmystere/sentry-unreal/pull/184))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.51.0)
