...
- Bump Java SDK (Android) from v8.16.0 to v8.33.0 ([#84](https://github.com/Maxmystere/sentry-unreal/pull/84))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.33.0)
