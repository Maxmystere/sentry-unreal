...
- Bump Java SDK (Android) from v8.16.0 to v8.25.0 ([#45](https://github.com/Maxmystere/sentry-unreal/pull/45))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.25.0)
