...
- Bump Java SDK (Android) from v8.16.0 to v8.50.0 ([#180](https://github.com/Maxmystere/sentry-unreal/pull/180))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.50.0)
