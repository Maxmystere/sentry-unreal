...
- Bump Java SDK (Android) from v8.16.0 to v8.39.1 ([#120](https://github.com/Maxmystere/sentry-unreal/pull/120))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.39.1)
