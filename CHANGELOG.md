...
- Bump Java SDK (Android) from v8.16.0 to v8.28.0 ([#59](https://github.com/Maxmystere/sentry-unreal/pull/59))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.28.0)
