...
- Bump Java SDK (Android) from v8.16.0 to v8.49.0 ([#175](https://github.com/Maxmystere/sentry-unreal/pull/175))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8490)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.49.0)
