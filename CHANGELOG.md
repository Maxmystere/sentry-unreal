...
- Bump Java SDK (Android) from v8.16.0 to v8.48.0 ([#172](https://github.com/Maxmystere/sentry-unreal/pull/172))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.48.0)
