...
- Bump Java SDK (Android) from v8.16.0 to v8.22.0 ([#29](https://github.com/Maxmystere/sentry-unreal/pull/29))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.22.0)
