...
- Bump Java SDK (Android) from v8.16.0 to v8.41.0 ([#131](https://github.com/Maxmystere/sentry-unreal/pull/131))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.41.0)
