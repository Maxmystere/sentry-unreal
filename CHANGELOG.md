...
- Bump Java SDK (Android) from v8.16.0 to v8.35.0 ([#101](https://github.com/Maxmystere/sentry-unreal/pull/101))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.35.0)
