...
- Bump Java SDK (Android) from v8.16.0 to v8.29.0 ([#64](https://github.com/Maxmystere/sentry-unreal/pull/64))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.29.0)
