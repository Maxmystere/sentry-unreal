...
- Bump Java SDK (Android) from v8.16.0 to v8.27.1 ([#56](https://github.com/Maxmystere/sentry-unreal/pull/56))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.27.1)
