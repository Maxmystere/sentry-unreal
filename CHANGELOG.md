...
- Bump Java SDK (Android) from v8.16.0 to v8.34.1 ([#96](https://github.com/Maxmystere/sentry-unreal/pull/96))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.34.1)
