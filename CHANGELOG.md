...
- Bump Java SDK (Android) from v8.16.0 to v8.58.0 ([#214](https://github.com/Maxmystere/sentry-unreal/pull/214))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8580)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.16.0...8.58.0)
